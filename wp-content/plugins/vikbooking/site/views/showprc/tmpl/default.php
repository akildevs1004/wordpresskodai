									...
									?>
											<div class="vbo-showprc-price-entry">
												<div class="vbo-showprc-price-entry-radio">
													<input type="radio" checked class="vbo-radio" data-roomnum="<?php echo $num; ?>" data-ratecost="<?php echo $rplan_cost; ?>" data-ratecostbase="<?php echo $rplan_basecost; ?>" name="priceid<?php echo $num; ?>" id="pid<?php echo $num . $t['idprice']; ?>" value="<?php echo $t['idprice']; ?>" <?php echo (($k == 0 && empty($rate_plan_id)) || $rate_plan_id == $t['idprice'] ? " checked=\"checked\"" : ""); ?> />
												</div>
												<div class="vbo-showprc-price-entry-rateplan">
													<!-- <label for="pid<?php echo $num . $t['idprice']; ?>"><?php echo $priceinfo['name']; ?></label> -->
													<label for="pid<?php echo $num . $t['idprice']; ?>">Price</label>
													<?php
